...
/// WelcomeScreen — "Home Splash 1", tampil pertama untuk user yang belum login.
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: Stack(
                        ...
                        children: [
                          // Ambient radial glow (template style)
                          Container(
                            width: 280,
                            height: 280,
                            decoration: BoxDecoration(
                          ...
                          // Floating badge: Trending Up (Top Right)
                          Positioned(
                            top: 10,
                            right: -4,
                            child: _badge(
                          ...
                          // Floating badge: Key (Bottom Left)
                          Positioned(
                            bottom: 16,
                            left: -12,
                            child: _badge(
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Text(
                        'Pantau okupansi, catat keuangan, dan tangani\nkomplain penghuni dalam satu genggaman.',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.poppins(
